...
export default function Plans() {
  ...
  useEffect(() => {
    ...
    ((script.async = true), (script.id = "razorpay-script"));
  ...
  async function handleSelect(plan) {
    ...
    // console.log(data);
    try {
      const { subscriptionsId } = await createsubscription(plan.id);
      openRazorpayPopup({ subscriptionsId });
...
function openRazorpayPopup({ subscriptionsId, user, course, onClose }) {
